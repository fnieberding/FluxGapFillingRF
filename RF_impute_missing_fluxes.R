RF_impute_missing_fluxes <- 
  ...
  predictors <- predictors[-which(predictors == "Timestamp" | predictors == "Year" | predictors == Flux)]
  ...
  # write result
  write.csv(result,paste0("./RF_results/pred_RF_", Flux, "_", Year, "_", impute, "_", N_trees, ".csv"), row.names = F)
  ...
  ggsave(paste0("./RF_plots/RF_", Flux, "_", Year, "_", impute, "_", N_trees, ".png"), plot = p, width = 16, height = 9, dpi = 300)
}