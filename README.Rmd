...
The function in _RF_impute_missing_fluxes.R is basically a convenient wrapper using caret::train to perform gap-filling of input variables using randomForest. It is based on the code provided by [Yeonuk Kim](https://github.com/yeonukkim/EC_FCH4_gapfilling) based on his recent publication in Global Change Biology: <https://doi.org/10.1111/gcb.14845>.
